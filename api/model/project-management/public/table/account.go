...
func newAccountTableImpl(schemaName, tableName, alias string) accountTable {
	var (
		...
		allColumns      = postgres.ColumnList{IDColumn, UsernameColumn, TypeColumn, StatusColumn, CreatedAtColumn, UpdatedAtColumn}
		mutableColumns  = postgres.ColumnList{UsernameColumn, TypeColumn, StatusColumn, CreatedAtColumn, UpdatedAtColumn}
	)
